...
namespace kingsightapi.Services
{
    ...
    public sealed class UserService : IUserService
    {
        ...
        private const string ListSql = """
            ...
            from input.UserMst u
            left join input.RoleMst r on u.RoleId = r.RoleId
            order by u.UserId
            """;
        ...
        private const string DeleteSql = "delete from input.UserMst where UserId = @user_id";

        private const string EmailExistsSql = """
            select 1 from input.UserMst

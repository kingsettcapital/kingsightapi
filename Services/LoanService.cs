...
//        Task<bool> UpdateInvestorAliasAsync(int loanKey, LoanInvestorAliasUpdateRequest request);
...
//        public async Task<bool> UpdateInvestorAliasAsync(int loanKey, LoanInvestorAliasUpdateRequest request)
//        {
//            await using var connection = new SqlConnection(_connectionString);
//            await connection.OpenAsync();
